...
import com.github.gemsnote.database.NoteTagDataStore;
...
import static com.github.gemsnote.service.NoteService.SP_HAS_FTS_FULL_BUILD;
                ...
                new Observable.OnSubscribe<Void>() {
                    ...
                    public void call(Subscriber<? super Void> subscriber) {
                        if (!subscriber.isUnsubscribed()) {
                            ...
                            NoteHistoryDataStore.deleteAllByUserId(userId);
                            currentUser.setNoteUsn(0);
                            currentUser.setNotebookUsn(0);
                            currentUser.setTagUsn(0);
                            currentUser.update();
