...
import com.github.gemsnote.adapter.AccountAdapter;
import com.github.gemsnote.adapter.NotebookAdapter;
import com.github.gemsnote.adapter.TagAdapter;
...
import com.github.gemsnote.service.AccountService;
import com.github.gemsnote.service.NotebookService;
import com.github.gemsnote.service.TagService;
import com.github.gemsnote.utils.DisplayUtils;
import com.github.gemsnote.utils.OpenUtils;
import com.github.gemsnote.utils.ToastUtils;
import com.github.gemsnote.widget.AlphabetDrawable;
import com.github.gemsnote.widget.TriangleView;
import com.github.gemsnote.widget.spinner.SpinnerArrayAdapter;
...
public class Navigation {
    ...
    private void initTagPanel() {
        ...
        mTagAdapter.setListener(new TagAdapter.TagAdapterListener() {
            ...
            @Override
            public void onLongClickedTag(final Tag tag) {
                new AlertDialog.Builder(mActivity)
                        .setTitle(tag.getText())
                        .setItems(new CharSequence[]{mActivity.getString(R.string.delete)}, new DialogInterface.OnClickListener() {
                            @Override
    ...
    private void deleteTag(final Tag tag) {
        Observable.create(
                new Observable.OnSubscribe<Tag>() {
                    @Override
    ...
    @OnClick(R.id.rl_trash)
    void clickedTrash() {
        mCurrentMode = NoteFragment.Mode.TRASH;
        if (mCallback != null) {
            if (mCallback.onShowNotes(mCurrentMode)) {
                close();
            }
    ...
    void clickedWeb() {
        ...
        if (host == null || host.equals("")) {
            ToastUtils.show(mActivity, R.string.host_address_is_incorrect);
            return;
        }
        OpenUtils.openUrl(mActivity, host);
    }
}
