...
import com.github.gemsnote.ui.BaseActivity;
...
import com.github.gemsnote.utils.ShareUtils;
import com.github.gemsnote.utils.ToastUtils;
import com.github.gemsnote.widget.LeaViewPager;
                ...
                filterUnchanged()
                        ...
                        .subscribe(new Observer<Long>() {
                            ...
                            public void onError(Throwable e) {
                                DialogDisplayer.dismissProgress();
                                ToastUtils.show(Gemsnote.getContext(), e.getMessage());
