...
import com.github.gemsnote.model.Account_Table;
import com.github.gemsnote.model.Note;
import com.github.gemsnote.model.Note_Table;
import com.github.gemsnote.model.RelationshipOfNoteTag;
import com.github.gemsnote.model.Tag;
import com.github.gemsnote.model.Tag_Table;

@Database(name = "gemsnote_db", version = 6)
public class AppDataBase {
    ...
    public static class AddTagUsnColumn extends AlterTableMigration<Account> {

        public AddTagUsnColumn(Class<Account> table) {
            super(table);
        }
        ...
        public void onPreMigrate() {
            super.onPreMigrate();
            addColumn(SQLiteType.INTEGER, "tagUsn");
        }
    }

    @Migration(version = 6, priority = 0, database = AppDataBase.class)
    public static class CreateNoteHistoryTable extends BaseMigration {
        @Override
        public void migrate(DatabaseWrapper database) {
            database.execSQL("CREATE TABLE IF NOT EXISTS `NoteHistory` ("
