...
import com.github.gemsnote.ReadableException;
...
import com.github.gemsnote.model.UpdateRe;
...
import com.github.gemsnote.utils.StringUtils;
...
public class NoteService {
    ...
    public static void saveNote(final long noteLocalId) {
        ...
        // snapshot the current content into local history before pushing (desktop parity)
        NoteHistoryDataStore.addHistory(Account.getCurrent().getUserId(),
                noteLocalId,
                modifiedNote.getNoteId(),
                modifiedNote.getContent(),
                modifiedNote.isMarkDown(),
                modifiedNote.getUpdatedTimeVal());
    ...
    public static void restoreNotesOnLocal(Note note) {
    ...
    public static void deleteNote(Note note) {
        ...
        NoteHistoryDataStore.deleteAllByNote(note.getId());
    }
