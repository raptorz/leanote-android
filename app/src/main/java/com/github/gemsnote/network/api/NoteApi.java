...
public interface NoteApi {
    ...
    @GET("note/getTrashNotes")
    Call<List<Note>> getTrashNotes();
    ...
    @GET("note/getHistories")
    Call<HistoryListRe> getHistories(@Query("noteId") String noteId);

    @GET("note/getHistoryContent")
    Call<HistoryContentRe> getHistoryContent(@Query("noteId") String noteId, @Query("historyId") String historyId);
}
